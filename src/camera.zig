...
pub const Camera = struct {
    ...
    vfov: f64 = 90.0,
    lookfrom: Point3 = .{},
    lookat: Point3 = Point3.init(0.0, 0.0, -1.0),
    ...
    _pixel_samples_scale: f64 = undefined,
    ...
    fn initialize(self: *Camera) void {
        ...
        self._image_height = if (height_float < 1.0) 1 else @intFromFloat(height_float);
        ...
        // camera coordinate frame unit basis vectors
        ...
        const defocus_radius = self.focus_dist * std.math.tan(
            utils.degreesToRadians(self.defocus_angle) / 2.0,
        );
    ...
    fn sampleSquare() Vec3 {
        return Vec3.init(utils.randomFloat() - 0.5, utils.randomFloat() - 0.5, 0.0);
    }
    ...
    fn getRay(self: Camera, i: usize, j: usize) Ray {
        ...
        const ray_origin = if (self.defocus_angle <= 0.0) self._center else self.defocusDiskSample();
